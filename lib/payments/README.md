...
| `payment-intent.ts` | Payment intent lifecycle |
| `agent-wallet.ts` | Agent identity and Stripe Connect linking |
...
```typescript
import { createPaymentIntent, capturePayment } from './stripe';
